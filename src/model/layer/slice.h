 ...
 */
#ifndef SRC_MODEL_LAYER_SLICE_H_
#define SRC_MODEL_LAYER_SLICE_H_
#include <string>
#include <utility>
#include <vector>
...
class Slice : public Layer {
 public:
  // const std::string layer_type() const override { return "Slice"; }
   ...
   const size_t axis() const { return axis_; }
   const vector<size_t> slice_point() const { return slice_point_; }
...
#endif  // SRC_MODEL_LAYER_SLICE_H_
